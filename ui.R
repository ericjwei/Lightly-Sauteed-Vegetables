...
bar.panel <- tabPanel('Earthquake Magnitude by Location', titlePanel('Earthquake Magnitude by Location'),
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          textInput("address", label = h3("Enter Location"), value = "Seattle", placeholder = "City or State"),
                          
                          sliderInput("radius", label = h3("Radius (km)"), min = 0,
                                      max = 500, value = 50),
                          sliderInput("number", label = h3("Max Number of Earthquakes"), min = 0,
                                      max = 1000, value = 50)
                        ),
                        mainPanel(
                          plotlyOutput('bar')
                                ...
                                sidebarLayout(
                                  sidebarPanel(
                                    ...
                                    p("To get an idea for the graphs used, visit ",
                                      a("plot.ly.", href = "https://plot.ly/r/")),
                                    
                                    p("To see our code, visit our github repository by clicking ",
                                      a("here.", href = "https://github.com/ericjwei/Lightly-Sauteed-Vegetables")),
                                  ...
                                  mainPanel(
                                    ...
                                    br(),
                                    h1("Why?"),
                                    p("For our project we wanted to use data that is both relevant to the us, since UW is near a fault line, but will also be of use to anyone because the data we use is global. We also wanted to both inform and entertain
                                    ...
                                    br(),
                                    h2("Disclaimer"),
                                    p("The graphs are for the Info 201 project only and should in no way be used as a warning for earthquakes."),
                                    br(),
